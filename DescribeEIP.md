...
|EIPBinding|object|EIP绑定内网IP关系数据|No|
...
|ResourceEipDirectMode|bool|ResourceType为“uni”时，此参数标识是否开启网卡的EIP直通模式|No|
|ResourceID|string|已绑定资源的资源ID|No|
|SubResourceType|string|资源绑定的虚拟网卡的类型。uni，虚拟网卡。|No|
|SubResourceEipDirectMode|bool|SubResourceType为“uni”时，此参数标识是否开启网卡的EIP直通模式|No|
